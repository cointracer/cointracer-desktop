...
Public Class CSVHelper
    ...
    Public ReadOnly Property Line(i As Integer) As String
        Get
            Return _AllLines(i)
        End Get
    End Property
    ...
    Public Function ReadAllLines() As Boolean
        If _AllLines Is Nothing Then
            Try
    ...
    Public Function FirstLine() As String
    ...
    Private Function ProcessAllLines(Optional ByVal SkipFirstRow As Boolean = True) As Integer
    ...
    Public Function ReadAllRows(Optional SkipFirstLine As Boolean = True,
                                ...
                                Optional DecimalSeparator As String = ",")
    ...
    ''' </summary>
    Public Function StringToDecimal(ByVal NumberAsString As String) As Decimal
    ...
    Public Sub SetCsvLinePreprocessor(ByVal CsvLineProcessRoutine As CsvLinePreprocessorDelegate)
    ...
    Public Sub SetCsvContentAnalyser(ByVal CsvContentAnalyseRoutine As CsvContentAnalyserDelegate)
