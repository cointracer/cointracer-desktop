...
Public Class Import_BitcoinCashNode
    ...
    Public Sub New(MainImportObject As Import)
        ...
        Platform = PlatformManager.Platforms.WalletBCH
        CSVAutoDetectEncoding = True
        MultiSelectFiles = False
        CSVSkipFirstLine = False
        FileDialogTitle = My.Resources.MyStrings.importOpenFileTitleBitcoinCashNode
        CheckFirstLine = True
        CSVSeparator = ","
    End Sub
    ...
    Friend Overrides Function ImportContent() As Boolean Implements IFileImport.ImportContent
        Return Import_SomecoinCoreCSV.ImportCSV(Me, AccountManager.Accounts.BCH)
    End Function
