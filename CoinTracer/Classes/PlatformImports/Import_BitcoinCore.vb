...
Public Class Import_BitcoinCore
    ...
    Public Sub New(MainImportObject As Import)
        ...
        Platform = PlatformManager.Platforms.WalletBTC
        CSVAutoDetectEncoding = True
        MultiSelectFiles = False
        CSVSkipFirstLine = False
        FileDialogTitle = My.Resources.MyStrings.importOpenFileTitleBitcoinCore
        CheckFirstLine = True
        CSVSeparator = ","
    End Sub
    ...
    Friend Overrides Function ImportContent() As Boolean Implements IFileImport.ImportContent
        Return Import_SomecoinCoreCSV.ImportCSV(Me, AccountManager.Accounts.BTC)
    End Function
