...
''' </summary>
Public Class DataGridViewAutoFilterCheckBoxColumn
...
#Region "public properties: FilteringEnabled, AutomaticSortingEnabled, DropDownListBoxMaxLines"
    ...
    ''' </summary>
    <Browsable(True)> _
    <DefaultValue("(Alles auswählen)")> _
    ...
    ''' <summary>
    ''' Caption for the last entry in filter list: default "(Leere)"
    ''' </summary>
    <Browsable(True)> _
    ...
    Public Property CaptionCheckedValues() As String
        Get
            Return CType(HeaderCell, DataGridViewAutoFilterColumnHeaderCell).CaptionCheckedValues
        End Get
        Set(ByVal value As String)
            CType(HeaderCell, DataGridViewAutoFilterColumnHeaderCell).CaptionCheckedValues = value
        End Set
    End Property
    ...
    Public Property CaptionUncheckedValues() As String
        Get
            Return CType(HeaderCell, DataGridViewAutoFilterColumnHeaderCell).CaptionUncheckedValues
        End Get
        Set(ByVal value As String)
            CType(HeaderCell, DataGridViewAutoFilterColumnHeaderCell).CaptionUncheckedValues = value
        End Set
    End Property
