...
$sqlBinaryPathx86 = Join-Path $packagePath "nativeBinaries\x86\SqlServerSpatial120.dll"
$sqlBinaryPathx64 = Join-Path $packagePath "nativeBinaries\x64\SqlServerSpatial120.dll"
...
$sqlLinkx86 = $folderx86.ProjectItems | where Name -eq "SqlServerSpatial120.dll"
if (!$sqlLinkx86)
{
...
$sqlLinkx64 = $folderx64.ProjectItems | where Name -eq "SqlServerSpatial120.dll"
if (!$sqlLinkx64)
{
